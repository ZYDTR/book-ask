...
xcrun swiftc -swift-version 5 -O -framework AppKit -framework Foundation -framework ApplicationServices \
  "$project_dir/src/DiagnosticLog.swift" "$project_dir/src/ReadingContext.swift" "$project_dir/src/BooksSelection.swift" "$project_dir/src/SelectionTrigger.swift" "$project_dir/src/ReadingTextArea.swift" "$project_dir/src/ReadingPreferences.swift" "$project_dir/src/ReadingPanelController.swift" "$project_dir/src/ReadingPanelPlacement.swift" "$project_dir/src/WordbookStore.swift" "$project_dir/src/WordbookWindow.swift" "$project_dir/src/ClipboardCapture.swift" "$project_dir/src/BooksCopy.swift" "$project_dir/src/main.swift" \
